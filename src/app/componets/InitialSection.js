...
export default function HeroSection() {
  return (
<div className="flex flex-col lg:flex-row items-center justify-between pt-20 bg-black mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
  <div className="lg:w-1/2 mb-6 lg:mb-2 text-center lg:text-left">
    ...
    <div className="flex flex-row justify-center lg:justify-start space-x-3 mb-1 sm:mb-4">
      <Link href="/get-started" className="px-3 py-2 sm:px-6 sm:py-3 text-sm sm:text-base bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-center">
        Conocer más
      </Link>
      <Link href="/demo" className="px-3 py-2 sm:px-6 sm:py-3 text-sm sm:text-base border border-gray-700 hover:bg-gray-800 rounded-md transition text-center">
        Contáctanos
      </Link>
    </div>
